#!/bin/bash
#SBATCH --job-name=mer_hour_%a
#SBATCH --output=logs/mer_hour_%a_%j.out
#SBATCH --error=logs/mer_hour_%a_%j.err
#SBATCH --array=13-13
...
julia --project=. src/setup_mer_simulation_hourly_parallel.jl $HOUR
